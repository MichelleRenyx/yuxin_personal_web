...
export const WhatDoIHelp = [
  "I am a results-oriented and innovative Software Engineer specializing in both frontend and backend Web Application Development, with a solid foundation in various commonly used development technologies.",
  "Proficient in Java, JavaScript (React), Spring Boot, and RESTful APIs, with extensive experience in DevOps tools (Git, Maven, Docker), Micro-Service architechture, and Cloud technologies (AWS). Demonstrated expertise in working within an Agile development environment, focusing on delivering practical, production-ready projects on time.",
...
export const boldWords = ["•", "JavaScript", "Java", "Spring Boot", "RESTful APIs", "DevOps", "Micro-Service", "Cloud", "AWS", "Agile", "production-ready", "problem-solving", "collaborative", "web application development"];
...
export const workExp = [
  {
    ...
    detail: "Involved in key projects focusing on the design and implementation of user management functionalities and assisted in maintaining the overall system stability and performance monitoring.",
    techStack: "Java, SQL, SpringMVC, Nacos, Redis, Skywalking",
    awards: "Designed and implemented the backend part of the 'User Management System' based on Product prototype and interface documentation using SpringMVC architecture. \n Ensure stable service registration and configuration after system reboots by Nacos.\n Participated in integrating Skywalking to monitor system performance and supported service anomaly notifications, such as sending alerts via DingTalk and email. \n Updated system documentation to improve team operational efficiency and system reliability.",
  },
  {
